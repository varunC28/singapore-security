...
export const MOCK_CATEGORIES: Category[] = [
  { id: 'cat-1', name: 'Cameras', slug: 'cameras', created_at: '' },
  { id: 'cat-2', name: 'DVR/NVR', slug: 'dvr-nvr', created_at: '' },
  { id: 'cat-3', name: 'Hard Disks', slug: 'hard-disks', created_at: '' },
  { id: 'cat-4', name: 'Cables', slug: 'cables', created_at: '' },
